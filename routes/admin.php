...
Route::prefix('admin')->name('admin.')->group(function(){
    ...
    Route::middleware('admin','adminStatusCheck')->group(function(){
        ...
        Route::get('/seats/get/service/type/{type}',[SeatController::class,'getServiceType']);
        Route::get('/seats/get/service/type/charge/{id}/{days}/{number}',[SeatController::class,'getServiceTypeCharge']);
        /** Seats End */
