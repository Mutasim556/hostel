                        ...
                        <div class="row">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="radio" name="booking_person_gender" id="gender_male" value="Male"> {{ __('admin_local.Male') }} &nbsp; &nbsp;
                                    <input type="radio" name="booking_person_gender" id="gender_female" value="Female"> {{ __('admin_local.Female') }}
                                </div>
                                <div class="col-md-4 mb-3">
