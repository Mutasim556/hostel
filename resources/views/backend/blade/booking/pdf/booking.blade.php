    ...
    <div class="invoice-box">
        ...
        <div class="details">
            <table>
                ...
                @php
                    $bookingData = \App\Models\Admin\Booking::with('hostel','room')->where('id',$bookingI->bookings->first()->id)->first();
                    // dd($bookingData);
                @endphp
                <tr>
                ...
                <tr>
                    ...
                    <td>{{ $bookingI->service->service_name." [ ".$bookingI->service->service_type."-".$bookingI->service->service_code." ]" }}</td>
                </tr>
                service
                <tr>
