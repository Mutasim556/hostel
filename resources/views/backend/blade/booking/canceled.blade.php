 ...
 @push('title')
     {{ __('admin_local.Cancelled Booking List') }}
 @endpush
 @push('css')
             ...
             <div class="col-lg-12 mx-auto">
                 <div class="card">
                     <div class="card-header py-3" style="border-bottom: 2px dashed gray">
                         <h3 class="card-title mb-0 text-center">{{ __('admin_local.Cancelled Booking List') }}</h3>
                     </div>

                     <div class="card-body">
                         <div class="row">
                             <div class="col-md-12 mx-auto">
                                 <form action="{{ route('admin.booking.getCanceledBooking') }}" method="GET">
                                     <div class="row bg-info p-4 mb-4 text-center">
                                         ...
                                         <div class="col-md-4">
                                             ...
                                             <a href="{{ route('admin.booking.getCanceledBooking') }}" class="btn btn-danger">{{ __('admin_local.Reset') }}</a>
                                         </div>
                                     </div>
                                 </form>
                             </div>
