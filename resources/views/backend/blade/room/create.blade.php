                        ...
                        <form class="form" action="{{ route('admin.room.store') }}" method="POST" id="add_room_form">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4 col-xs-6 col-sm-6">
                                    ...
                                    <input type="number" class="form-control" id="total_window" name="total_window" value="1">
                                    <span class="text-danger err-mgs"></span>
                                </div>
                                <div class="form-group col-md-4 col-xs-6 col-sm-6">
                                    <label for="">{{ __('admin_local.Total Fan') }}</label>
                                    <input type="number" class="form-control" id="total_fan" name="total_fan" value="1">
                                    <span class="text-danger err-mgs"></span>
                                </div>
                                <div class="form-group col-md-4 col-xs-6 col-sm-6">
                                    <label for="">{{ __('admin_local.Total Light') }}</label>
                                    <input type="number" class="form-control" id="total_light" name="total_light" value="1">
                                    <span class="text-danger err-mgs"></span>
                                </div>
                            </div>
